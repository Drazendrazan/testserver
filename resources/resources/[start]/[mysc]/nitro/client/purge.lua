...
function SetVehicleNitroPurgeEnabled(vehicle, enabled)
  ...
  if enabled then
    ...
    for i=0,3 do
      local leftPurge = CreateVehiclePurgeSpray(vehicle, off.x - 0.5, off.y + 1.05, off.z - 0.8, 40.0, -40.0, 0.0, 0.5)
      local rightPurge = CreateVehiclePurgeSpray(vehicle, off.x + 0.5, off.y + 1.05, off.z - 0.8, 40.0, 40.0, 0.0, 0.5)
