...
Citizen.CreateThread(function()
	...
	AddTextEntry("npgem", "npgem")
	AddTextEntry("npolchar", "npolchar")
	AddTextEntry("npolexp", "npolexp")
	AddTextEntry("npolblazer", "npolblazer")
	AddTextEntry("npolvic", "npolvic")
	AddTextEntry("npolmm", "npolmm")
	AddTextEntry("npolvette", "npolvette")
	AddTextEntry("npolchal", "npolchal")
	AddTextEntry("npolstang", "npolstang")
	AddTextEntry("npolcoach", "npolcoach")
	AddTextEntry("bcat", "bcat")
	AddTextEntry("polnspeedo", "polnspeedo")
	AddTextEntry("emsnspeedo", "emsnspeedo")
	AddTextEntry("npolretinue", "npolretinue")
	AddTextEntry("ucwashington", "ucwashington")
	AddTextEntry("ucbanshee", "ucbanshee")
	AddTextEntry("ucrancher", "ucrancher")
	AddTextEntry("ucprimo", "ucprimo")
	AddTextEntry("uccoquette", "uccoquette")
	AddTextEntry("ucbuffalo", "ucbuffalo")
	AddTextEntry("ucballer", "ucballer")
	AddTextEntry("uccomet", "uccomet")
	AddTextEntry("polfegway", "polfegway")
	AddTextEntry("polas350", "polas350")
	AddTextEntry("EMSV", "EMSV")
	AddTextEntry("emsaw139", "emsaw139")
	AddTextEntry("volatus2", "volatus2")
	AddTextEntry("banshee2fix", "banshee2fix")
	AddTextEntry("hydra2", "hydra2")
	AddTextEntry("penumbra3", "penumbra3")
	AddTextEntry("npdrone", "npdrone")
	AddTextEntry("boxville7", "boxville7")
	AddTextEntry("tractorc", "tractorc")
	AddTextEntry("newsmav", "newsmav")
	AddTextEntry("newsvan", "newsvan")
	AddTextEntry("BIMX", "BIMX")
	AddTextEntry("filthynsx", "filthynsx")
	AddTextEntry("vulcan", "vulcan")
	AddTextEntry("srt8b", "srt8b")
	AddTextEntry("m2f22", "m2f22")
	AddTextEntry("honody", "honody")
	AddTextEntry("veln", "veln")
	AddTextEntry("kiagt", "kiagt")
	AddTextEntry("aamx", "aamx")
	AddTextEntry("v877", "v877")
	AddTextEntry("m3e30", "m3e30")
	AddTextEntry("mfc", "mfc")
	AddTextEntry("maj350z", "maj350z")
	AddTextEntry("s30", "s30")
	AddTextEntry("s14", "s14")
	AddTextEntry("s14boss", "s14boss")
	AddTextEntry("22b", "22b")
	AddTextEntry("rx811", "rx811")
	AddTextEntry("22m5", "22m5")
	AddTextEntry("gs350", "gs350")
	AddTextEntry("cliors", "cliors")
	AddTextEntry("ffrs", "ffrs")
	AddTextEntry("a45amg", "a45amg")
	AddTextEntry("CGT", "CGT")
	AddTextEntry("68dart", "68dart")
	AddTextEntry("mbc63", "mbc63")
	AddTextEntry("npcul", "npcul")
	AddTextEntry("nis180", "nis180")
	AddTextEntry("gt86", "gt86")
	AddTextEntry("rr14", "rr14")
	AddTextEntry("lc100", "lc100")
	AddTextEntry("22g63", "22g63")
	AddTextEntry("victor", "victor")
	AddTextEntry("675ltsp", "675ltsp")
	AddTextEntry("lc500", "lc500")
	AddTextEntry("bolide", "bolide")
	AddTextEntry("JESKO2020", "JESKO2020")
	AddTextEntry("chiron17", "chiron17")
	AddTextEntry("starone", "starone")
	AddTextEntry("bt62r", "bt62r")
	AddTextEntry("lp700", "lp700")
	AddTextEntry("gt17", "gt17")
	AddTextEntry("488misha", "488misha")
	AddTextEntry("r32", "r32")
	AddTextEntry("r8h", "r8h")
	AddTextEntry("m4", "m4")
	AddTextEntry("lfa", "lfa")
	AddTextEntry("db11", "db11")
	AddTextEntry("tsgr20", "tsgr20")
	AddTextEntry("deluxo2", "deluxo2")
	AddTextEntry("deluxo6str", "deluxo6str")
	AddTextEntry("senna", "senna")
	AddTextEntry("asbo2", "asbo2")
	AddTextEntry("z190custom", "z190custom")
	AddTextEntry("r8v10", "r8v10")
	AddTextEntry("v242", "v242")
	AddTextEntry("720s", "720s")
	AddTextEntry("rudiharley", "rudiharley")
	AddTextEntry("zx10", "zx10")
	AddTextEntry("bmwr", "bmwr")
	AddTextEntry("bluecunt", "bluecunt")
	AddTextEntry("m5e60", "m5e60")
	AddTextEntry("f10m5rc", "f10m5rc")
	AddTextEntry("500gtrlam", "500gtrlam")
	AddTextEntry("evo9", "evo9")
	AddTextEntry("m3e46", "m3e46")
	AddTextEntry("esv", "esv")
	AddTextEntry("DC5", "DC5")
	AddTextEntry("granlb", "granlb")
	AddTextEntry("r35", "r35")
	AddTextEntry("gtr", "gtr")
	AddTextEntry("tempesta2", "tempesta2")
	AddTextEntry("por930", "por930")
	AddTextEntry("na1", "na1")
	AddTextEntry("gtrc", "gtrc")
	AddTextEntry("raid", "raid")
	AddTextEntry("cp9a", "cp9a")
	AddTextEntry("e36prb", "e36prb")
	AddTextEntry("mig", "mig")
	AddTextEntry("bc", "bc")
	AddTextEntry("pgt322", "pgt322")
	AddTextEntry("69charger", "69charger")
	AddTextEntry("C7", "C7")
	AddTextEntry("demon", "demon")
	AddTextEntry("mustang19", "mustang19")
	AddTextEntry("na6", "na6")
	AddTextEntry("r1", "r1")
	AddTextEntry("audirs6tk", "audirs6tk")
	AddTextEntry("rcf", "rcf")
	AddTextEntry("gt63", "gt63")
	AddTextEntry("FK8", "FK8")
	AddTextEntry("exor", "exor")
	AddTextEntry("lp670", "lp670")
	AddTextEntry("fnfrx7", "fnfrx7")
	AddTextEntry("f150", "f150")
	AddTextEntry("panamera17turbo", "panamera17turbo")
	AddTextEntry("s15rb", "s15rb")
	AddTextEntry("z2879", "z2879")
	AddTextEntry("contss18", "contss18")
	AddTextEntry("bdragon", "bdragon")
	AddTextEntry("delsoleg", "delsoleg")
	AddTextEntry("a80", "a80")
	AddTextEntry("subwrx", "subwrx")
	AddTextEntry("rmodmustang", "rmodmustang")
	AddTextEntry("rx7rb", "rx7rb")
	AddTextEntry("ap2", "ap2")
	AddTextEntry("66fastback", "66fastback")
	AddTextEntry("acs8", "acs8")
	AddTextEntry("fnf4r34", "fnf4r34")
	AddTextEntry("p1", "p1")
	AddTextEntry("laferrari17", "laferrari17")
	AddTextEntry("ellie6str", "ellie6str")
	AddTextEntry("futo3", "futo3")
	AddTextEntry("gauntlet6str", "gauntlet6str")
	AddTextEntry("ladybird6str", "ladybird6str")
	AddTextEntry("ruiner6str", "ruiner6str")
	AddTextEntry("schwarzer2", "schwarzer2")
	AddTextEntry("sentinel6str2", "sentinel6str2")
	AddTextEntry("yosemite6str", "yosemite6str")
	AddTextEntry("zr3806str", "zr3806str")
	AddTextEntry("tampa5", "tampa5")
	AddTextEntry("tampa4", "tampa4")
	AddTextEntry("revolution6str", "revolution6str")
	AddTextEntry("revolution6str2", "revolution6str2")
	AddTextEntry("sentinel6str", "sentinel6str")
	AddTextEntry("comet6str", "comet6str")
	AddTextEntry("pigalle6str", "pigalle6str")
	AddTextEntry("hoabrawler", "hoabrawler")
	AddTextEntry("tessaoracle", "tessaoracle")
	AddTextEntry("dilettante3", "dilettante3")
	AddTextEntry("payneschaf", "payneschaf")
	AddTextEntry("dabneon", "dabneon")
	AddTextEntry("npneon", "npneon")
	AddTextEntry("mwgranger", "mwgranger")
	AddTextEntry("vustretch", "vustretch")
	AddTextEntry("vuwashington", "vuwashington")
	AddTextEntry("hustler6str", "hustler6str")
	AddTextEntry("nptaco", "nptaco")
	AddTextEntry("sentinelsg4", "sentinelsg4")
	AddTextEntry("tractorcv8", "tractorcv8")
	AddTextEntry("UNICYCLE", "UNICYCLE")
	AddTextEntry("sultanrsv8", "sultanrsv8")
	AddTextEntry("stratumc", "stratumc")
	AddTextEntry("taxirooster", "taxirooster")
	AddTextEntry("primoard", "primoard")
	AddTextEntry("hellion6str", "hellion6str")
	AddTextEntry("npwheelchair", "npwheelchair")
	AddTextEntry("kart", "kart")
	AddTextEntry("skart", "skart")
	AddTextEntry("chillybin", "chillybin")
	AddTextEntry("savanna", "savanna")
	AddTextEntry("an225", "an225")
